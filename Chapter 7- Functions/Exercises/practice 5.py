# Practice 5: Write a Python program that defines a function to check whether a given number is prime.

# Defining the "prime_checker" function to take Number as a parameter.
...
# Calls the "prime_checker" funtion with the inputted number from "Number" as an argument and determines the returned value.
