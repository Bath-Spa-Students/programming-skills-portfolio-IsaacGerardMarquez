# Practice 3: Write a Python program to iterate through the values of a dictionary and print them.
...
# Use for loop to iterate through the values of the dictionary named "Isaac_Introduction".
for value in Isaac_Introduction.values():
    
# Use print() function to print or display each "value" on a separate line.
    print(value)