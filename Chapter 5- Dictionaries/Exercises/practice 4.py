# Practice 4: Write a Python program to iterate through both the keys and values of a dictionary and print them.
...
# Use for loop and "items()"to iterate through both the keys and values of the dictionary named "Isaac_Introduction".
for key, value in Isaac_Introduction.items():
    
# Use print() function to print or display each "key" and "value" on a separate line.
    print(key, value)